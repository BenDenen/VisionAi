...
Java_com_bendenen_visionai_tflite_utils_NativeImageUtilsWrapper_resizeImage(JNIEnv *env,
                                                                     jobject /* this */,
...
JNIEXPORT void JNICALL
Java_com_bendenen_visionai_tflite_utils_NativeImageUtilsWrapper_resizeAndNormalizeImage(JNIEnv *env,
                                                                                 jobject /* this */,
                                                                                 jbyteArray rgbaByteArray,
                                                                                 jint imgWidth,
                                                                                 jint imgHeight,
